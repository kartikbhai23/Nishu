...
async function fetchRepos() {
  ...
  const user = CONFIG_GITHUB_USER || 'nishu-tiwari82';
...
async function renderRepos() {
  ...
  try {
    ...
    const u = CONFIG_GITHUB_USER || 'nishu-tiwari82';
    grid.innerHTML = `
...
function buildContact() {
  ...
  if (card) {
    const rows = [
      ...
      { icon: 'fab fa-linkedin-in', val: 'nishu-tiwari', href: 'https://www.linkedin.com/in/nishu-tiwari/', lbl: 'LinkedIn' },
      { icon: 'fab fa-x-twitter', val: '@NishuTiwari', href: 'https://twitter.com/NishuTiwari', lbl: 'Twitter' },
    ];
