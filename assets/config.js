...
const CONFIG_SOCIALS = [
    { icon: 'fab fa-github', url: 'https://github.com/nishu-tiwari82', label: 'GitHub' },
    { icon: 'fab fa-linkedin-in', url: 'https://www.linkedin.com/in/nishu-tiwari/', label: 'LinkedIn' },
    { icon: 'fab fa-x-twitter', url: 'https://twitter.com/NishuTiwari', label: 'Twitter' },
    { icon: 'fab fa-instagram', url: 'https://www.instagram.com/nishu_tiwari/', label: 'Instagram' },
    { icon: 'fab fa-discord', url: 'https://discord.com/users/nishutiwari', label: 'Discord' },
];
...
const CONFIG_PROJECTS = [
    {
        ...
        github: 'https://github.com/nishu-tiwari82',
        demo: null,
    ...
    },
    {
        ...
        icon: 'fas fa-chart-line',
        category: 'Transformers',
        github: 'https://github.com/nishu-tiwari82/character-chatgpt',
        demo: null,
    ...
    // },
    {
        ...
        icon: 'fas fa-chart-line',
        category: 'Transformers',
        github: 'https://github.com/nishu-tiwari82/Language-Translation-Using-Transformer',
        demo: null,
...
const CONFIG_GITHUB_USER = 'nishu-tiwari82';
